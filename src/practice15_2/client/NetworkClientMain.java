...
public class NetworkClientMain {
    ...
    public static void main(String[] args) {
        ...
        for (RequestResponse lResponse : callables.keySet()) {
            Future<RequestResponse> future = callables.get(lResponse);
            try {
                lResponse = future.get();
                System.out.println(lResponse.host + ": " + lResponse.port + " " + lResponse.response);
