...
public class AbstractBankingMain {
    ...
    private static void initializeCustomers(Bank bank) {
        ...
        CheckingAccount ckAccount = new CheckingAccount(100.00);
        customer.addAccount(ckAccount);
        if (ckAccount.withdraw(900.00)) {
            customer.addAccount(ckAccount);
            System.out.print("Withdraw was successful : " + ckAccount.getBalance());
        }
